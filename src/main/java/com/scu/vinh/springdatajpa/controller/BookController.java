package com.scu.vinh.springdatajpa.controller;
...
import com.scu.vinh.springdatajpa.service.BookService;
...
public class BookController {
    ...
    public ResponseEntity<BookResponseDto> addAuthor(@PathVariable final Long bookId,
    ...
    public ResponseEntity<BookResponseDto> removeAuthor(@PathVariable final Long bookId,
                                                        @PathVariable final Long authorId) {
